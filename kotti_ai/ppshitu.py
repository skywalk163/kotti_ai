# /home/pyramid/PaddleClas/deploy/paddleserving/recognition
import numpy as np
...
index_dir = "/home/pyramid/PaddleClas/deploy/drink_dataset_v1.0/index"
...
def ppshitu(im=None):
    ...
    client.load_client_config([
        "/home/pyramid/PaddleClas/deploy/paddleserving/recognition/../../models/picodet_PPLCNet_x2_5_mainbody_lite_v1.0_client",
        "/home/pyramid/PaddleClas/deploy/paddleserving/recognition/../../models/general_PPLCNet_x2_5_lite_v1.0_client"
    ])
    client.connect(['127.0.0.1:9400'])

    if im is None : 
        # im = cv2.imread("/home/pyramid/PaddleClas/deploy/paddleserving/recognition/../../drink_dataset_v1.0/test_images/001.jpeg")
        im = cv2.imread("/home/pyramid/PaddleClas/deploy/paddleserving/recognition/../../drink_dataset_v1.0/test_images/100.jpeg")
    ...
    print(results)
    # with open("/home/pyramid/test.txt", "a") as f:
